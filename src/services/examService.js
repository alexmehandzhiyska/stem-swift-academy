...
const createOne = async(subject, section, instructions, duration, difficulty, link, text) => {
    const exam = await db.query('INSERT INTO exams (subject, section, duration, instructions, text, link, difficulty) VALUES ($1, $2, $3, $4, $5, $6) RETURNING *', [subject, section, duration, instructions, text, link, difficulty]);
    return exam.rows[0];
}

const updateOne = async(examId, subject, section, instructions, duration, difficulty, text, link) => {
