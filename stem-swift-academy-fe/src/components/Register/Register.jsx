    ...
    <section className="mt-40">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col justify-center items-center text-white" method="POST">
        <article className="my-2">
          ...
          {errors.name && <p className="text-blue-500 py-2">{errors.name.message}</p>}
        </article>
        ...
        <article className="my-2">
          ...
          {errors.email && <p className="text-blue-500 py-2">{errors.email.message}</p>}
        </article>
        ...
        <article className="my-2">
          ...
          {errors.password && <p className="text-blue-500 py-2">{errors.password.message}</p>}
        </article>
